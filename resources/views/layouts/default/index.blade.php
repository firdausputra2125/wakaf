...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <!-- CSS Just for demo purpose, don't include it in your project --> 
    <script src="{{ asset('')}}assets/plugins/moment/moment.js"></script>
    <link href="{{ asset('frontend/default/css/campaign.css')}}" rel="stylesheet">
    <link href="{{ asset('frontend/default/css/campaign.custom.css')}}" rel="stylesheet">
...
<body id="body">
 ...
 <script type="text/javascript" src="{{ asset('frontend/default/js/bootstrap.bundle.min.js')}}"></script>
