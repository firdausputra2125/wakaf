		 ...
		 <div class="row">
			<div class="col-md-9">
					...
					<div class="tab-content pt-5 bg-white">
						  <div class="tab-pane active m-t" id="info" style="margin:15px">
							...
							{!! Form::hidden('pageID', $row['pageID']) !!}	
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-8" >									
										<select class="form-control form-control-sm border" name="cid">
									  ...
									  <div class="form-group row  " >
										<label for="Userid" class=" control-label col-md-4 "> Relawan </label>
										<div class="col-md-8">
										  <select name='userid' rows='5' id='userid' class='select2 '   ></select> 
										</div>  
									  </div> 					
									  <div class="form-group row  " >
										<label for="Id Program" class=" control-label col-md-4 ">Program</label>
										<div class="col-md-8">
										  <select name='id_program' rows='5' id='id_program' class='select2 '></select> 
										</div> 
									  </div>
									  <div class="form-group row  " >
										<label for="Id Mushaf" class=" control-label col-md-4 ">Mushaf </label>
										<div class="col-md-8">
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-8">
										  <input  type='number' name='total_mushaf' id='total_mushaf' value='{{ $row['total_mushaf'] }}' 
						     				class='form-control form-control-sm ' /> 
										 </div> 
									  </div>
									  <div class="form-group row  " >
										...
										<div class="col-md-8">
										<textarea name='sinopsis' rows='5' id='sinopsis' class='form-control '>
											{{ $row['sinopsis'] }}
										</textarea> 
										 </div> 
									  </div> 										
