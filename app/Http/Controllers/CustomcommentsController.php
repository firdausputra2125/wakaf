...
class CustomcommentsController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'customcomments';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Customcomments();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'customcomments',
	...
	function show( Request $request , $id ) 
	{
		...
		switch( $task)
		{
			...
			case 'comboselect':
				...
				break;
			case 'publicselect':
				return $this->getPublicselect( $request );
				break;
			case 'import':
	...
	public static function display(  )
	{
		...
		$model  = new Customcomments();
		$info = $model::makeInfo('customcomments');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('customcomments.public.view',$data);			
			}			
		} 
		else {
			...
			return view('customcomments.public.index',$data);	
		}
