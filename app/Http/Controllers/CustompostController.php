...
class CustompostController extends Controller {
	...
	{		
		parent::__construct();
		$this->model = new Custompost();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'custompost',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('custompost');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('custompost.public.view',$data);			
			}			
		} 
		else {
			...
			return view('custompost.public.index',$data);	
		}
